...
import com.vitaOrganic.execptions.TransactionNotFoundException;
import com.vitaOrganic.execptions.UserNotLoggedInException;
import com.vitaOrganic.repository.TransactionsRepository;
...
public class TransactionsServiceImpl implements TransactionsService {
	...
	public Transactions changeStatus(Integer transactionId, String status) {
		...
		try {
			 transaction.setStatus(com.vitaOrganic.entity.TransactionStatus.valueOf(com.vitaOrganic.entity.TransactionStatus.class, status));
